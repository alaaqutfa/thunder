        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-[#384046]">Edit Service</h1>
                        <p class="mt-2 text-sm text-gray-600">Update service information</p>
                    </div>
                    ...
                    <form action="{{ route('admin.services.update', $service) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div>
                                ...
                                <select name="is_active" id="is_active"
                                    ...
                                    <option value="1" {{ old('is_active', $service->is_active) ? 'selected' : '' }}>
                                        Active</option>
                                    <option value="0" {{ !old('is_active', $service->is_active) ? 'selected' : '' }}>
                                        Inactive</option>
                                </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center bg-gray-50">
                                <div class="mb-3">
                                    <i id="iconPreview" class="{{ $service->icon }} text-4xl"></i>
                                </div>
                                <p class="text-sm text-gray-600" id="iconPreviewText">
                                    {{ $service->icon }}
                                </p>
