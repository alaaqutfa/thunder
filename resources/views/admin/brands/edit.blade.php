        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-[#384046]">Edit Brand</h1>
                        <p class="mt-2 text-sm text-gray-600">Update brand details and logo</p>
                    </div>
                    ...
                    <form action="{{ route('admin.brands.update', $brand) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="url" name="link" id="link" value="{{ old('link', $brand->link) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="order"
                                    value="{{ old('order', $brand->order) }}" min="0" placeholder="0"
                            ...
                            <div>
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="1" {{ old('status', $brand->status) ? 'selected' : '' }}>
                                        Active</option>
                                    <option value="0" {{ !old('status', $brand->status) ? 'selected' : '' }}>
                                        Inactive</option>
                                </select>
