...
@push('css')
    <style>
        /* الحفاظ على ألوان الهوية البصرية */
        :root {
            --accent-color: #cc1820;
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-[#384046]">Projects Management</h1>
                        <p class="mt-2 text-sm text-gray-600">Manage and organize your projects portfolio</p>
                    </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($projects as $project)
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-semibold text-[#384046]">{{ $project->name }}</div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $project->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <form action="{{ route('admin.projects.toggle-status', $project) }}"
                                                ...
                                                @csrf
                                                <button type="submit"
                                                    class="inline-flex items-center p-2 text-sm font-medium text-center {{ $project->is_active ? 'text-gray-700 bg-gray-100 hover:bg-gray-200' : 'text-green-700 bg-green-100 hover:bg-green-200' }} rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300 transition-colors duration-200"
                                ...
                                <tr>
                                    <td colspan="8" class="px-6 py-12 text-center">
                                        <div class="text-center">
                                            ...
                                            <p class="mt-1 text-sm text-gray-500">Get started by creating a new project.
                                            </p>
                                            <div class="mt-6">
                                                <a href="{{ route('admin.projects.create') }}"
            ...
            <!-- Pagination - فقط إذا كان pagination مدعوماً -->
